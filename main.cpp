...
void showCompileHelp() {
    std::cout << "ChocoLang Compiler v0.0.1" << std::endl;
...
bool compileChocoFile(const std::string& inputFile, const std::string& outputName, bool noGUI) {
    std::cout << "ChocoLang Compiler v0.6.0" << std::endl;
    ...
    output << "// Auto-generated by ChocoLang Compiler\n";
...
int main(int argc, char* argv[]) {
    ...
    if (argc == 1) {
        std::cout << "======================================" << std::endl;
        std::cout << "  ChocoLang 1.0.0 - Choco Crunch" << std::endl;
        std::cout << "  REPL (CocoaInterpreter v0.2.1)" << std::endl;
